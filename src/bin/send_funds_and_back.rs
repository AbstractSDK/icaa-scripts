...
use cw_orch::daemon::queriers::{Bank, Ibc};
...
use icaa_scripts::{IBC_CLIENT_ID, JUNO_1, press_enter_to_continue};
...
// Get the archway remote hosts
    ...
    let juno_info = remote_abstr.ans_host.resolve(&AssetEntry::from("juno>juno"))?;
